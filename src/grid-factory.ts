...
export class GridFactory {
  ...
  constructor(
    ...
    columnsMetadatas.forEach((metadata) => {
      ...
      const customColumn = GridFactory.generateCustomColumn(
        column,
  ...
  getAllColumnDepedencies() {
    console.log(...this.customColumnsMap
        .values()
        .toArray()
    ...
    return {
      ...
      valueGetter: (params) => {
        if (
          ...
          return "";
        return this.gridConfig.columnDateFormater!(
    ...
    return {
      ...
      valueGetter: (params) => {
        if (
          ...
          return "";
        return this.gridConfig.columnDatetimeFormater!(
          params.data[metaData.raw_field_name as keyof TRecord] as string,
        );
      },
      width: 150,
  ...
  static formatDateFn(dateValue: string | Date) {
  ...
  static formatDatetimeFn(dateValue: string | Date) {
    const date = new Date(dateValue);
    const day = date.getDate();
    const month = date.getMonth() + 1;
    const year = date.getFullYear();
